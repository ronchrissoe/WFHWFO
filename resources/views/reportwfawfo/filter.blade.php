...
@if (Route::currentRouteName() == 'report-filter')
    @section('title', 'Report WFH and WFO')
@elseif (Route::currentRouteName() == 'food-filter')
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            @if (Route::currentRouteName() == 'report-filter')
                                <a href="{{route('report')}}" type="button" class="btn btn-danger">Back</a>
                            @elseif (Route::currentRouteName() == 'schedule-filter')
                                <a href="{{route('schedule')}}" type="button" class="btn btn-danger">Back</a>
                            @else
                                <a href="{{route('food')}}" type="button" class="btn btn-danger">Back</a>
                            @endif
                        </div>
                    </div>
                </form>
                        ...
                        <div class="table-responsive p-0" style="height: 600px;">
                            <table id="example1" class="table table-bordered table-hover table-head-fixed text-nowrap">
                                        ...
                                        <center>
                                            @if ($item->kdstatus == 'APR' || $item->kdstatus == 'APRDR')
                                                ...
                                                @elseif($item->kerja == "Work From Home")
                                                    @if (Route::currentRouteName() == 'report-filter' || Route::currentRouteName() == 'schedule-filter')
                                ...
                                <tfoot style="text-align: center">
                                    <tr>
                                        <th style="background: white">Total Karyawan</th>
                                        <th></th>
