...
<head>
    ...
    <meta name="theme-color" content="#6b6865"/>
    ...
    <title>
        ...
        @yield('title', config('adminlte.title', 'WWS'))
    ...
    {{-- Base Stylesheets --}}
    <link rel="apple-touch-icon" href="{{asset('pwa/manifest/icon-192x192.png')}}">
    ...
    <script>
        UpUp.start({
            ...
            'assets': [
                ...
                '/pwa/js/upup.min.js',
                '/pwa/js/addtohomescreen.min.js',
                '/pwa/manifest/icon-192x192.png',
                '/pwa/manifest/icon-256x256.png',
                '/pwa/manifest/icon-384x384.png',
                '/pwa/manifest/icon-512x512.png'
            ],
