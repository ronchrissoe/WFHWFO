        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <form action="{{route('approvewfawfo.filter')}}" method="POST">
                            @csrf
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <a href="{{route('approvewfawfo.index')}}" type="button" class="btn btn-danger">Back</a>
                        </div>
                    </div>
                </form>
                </div>
                            ...
                            <table id="example1" class="table table-bordered table-hover table-head-fixed text-nowrap">
                                        ...
                                        <center>
                                            ...
                                            <td style="background: greenyellow">
                                                ...
                                                <a href="javascript:void(0)" data-id="{{$item->id}}"
                                                    class="btn btn-sm btn-warning editwfawfo">Edit</a>
                                                @else
                                                <br>
                                                <a href="javascript:void(0)" data-id="{{$item->id}}"
                                                    class="btn btn-warning editwfawfo">Edit</a>
                                                <a href="javascript:void(0)" data-id="{{$item->id}}"
                                                    class="btn btn-success approvewfawfo">Approve</a>
                                                <a href="javascript:void(0)" data-id="{{$item->id}}"
                                                    class="btn btn-danger rejectwfawfo">Reject</a>
                                                @endif
                                            </td>
                                            ...
                                            <td style="background: lightblue">
                                                ...
                                                <br>
                                                <a href="javascript:void(0)" data-id="{{$item->id}}"
                                                    class="btn-sm btn-warning editwfawfo">Edit</a>
                                                @else
                                                <br>
                                                <a href="javascript:void(0)" data-id="{{$item->id}}"
                                                    class="btn btn-warning editwfawfo">Edit</a>
                                ...
                                <tfoot style="text-align: center">
                                    <tr>
                                        ...
                                        <th>
                                            {{$jumlah->where('kerja',"Work From Office")->count()}}
                                        </th>
                                        @endforeach
                                    </tr>
                                    <tr>
                                        <th style="background: white">% (WFH)</th>
                                        <th></th>
                                        @foreach ($dates as $tanggal => $pers)
                                        @php
                                        $persen = $pers->where('kerja',"Work From Office")->count()/$pers->count()*100;
                                        @endphp
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input style="font-size: 14px;" type="date" class="form-control" id="tanggalupdate"
                                    name="tanggalupdate" value="" disabled>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label style="font-size: 14px;" for="kdkerjaupdate">Jadwal Kerja<span
                                        id="lblkdkerjaupdatespn"
                                        style="font-size: 14px;color:red;display:inline">&nbspX</span></label>
                                <select style="font-size: 14px;" id="kdkerjaupdate" name="kdkerjaupdate"
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label style="font-size: 14px;" for="kdmakananupdate">Makan Siang<span
                                        id="lblkdmakananupdatespn"
                                        style="font-size: 14px;color:red;display:inline">&nbspX</span></label>
                                <select style="font-size: 14px;" id="kdmakananupdate" name="kdmakananupdate"
                                    class="form-control" disabled>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label style="font-size: 14px;" for="keteranganupdate">Keterangan<span
                                        id="lblketeranganupdatespn"
                                        style="font-size: 14px;color:red;display:inline">&nbspX</span></label>
                                <input style="font-size: 14px;" type="text" class="form-control" id="keteranganupdate"
                                    name="keteranganupdate" value="" disabled>
                            </div>
                        </div>
                    </div>
                </form>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input style="font-size: 14px;" type="text" class="form-control" id="keteranganreject"
                                    name="keteranganreject" value="">
                            </div>
                        </div>
                    </div>
                </form>
